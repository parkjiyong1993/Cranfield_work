...
def plot_line_graph():
    ...
    # Add an 'All' option 
    # There is no auto deselection, even though erase -> still stay in memory 
    ...
    canvas_widget.configure(width=800, height=600)  # Adjust the width and height as necessary
    ...
    def plot_selected():
        ...
        fig = plt.figure(figsize=(8.5,6))  # Create a new figure
        ...
        plt.xlabel('Wc')
        plt.ylabel('PR')
        plt.title('Wc-PR graph for different Beta values')
        ...
        canvas.draw()
        #canvas_widget = canvas.get_tk_widget()
        #canvas_widget.configure(width=800, height=600)  # You can adjust the width and height as necessary
